...
local WING_TYPES = {
    { label = "Angel", dt = Vector3.new(0.3, 0.9, 0.3), db = Vector3.new(0.9, 0.3, 0.2), n = 14, ns = 5, l0 = 1.6, l1 = -5.5, d0 = 0.16, d1 = 0.06, backT = 0.7, bD0 = 0.14, sub = { dt = Vector3.new(0.7, -0.2, 0.3), db = Vector3.new(0.4, -0.8, 0.2), n = 8, ns = 4, l0 = 3.0, l1 = 1.2, d0 = 0.14, d1 = 0.05 } },
    { label = "Demon", dt = Vector3.new(0.2, 0.95, 0.2), db = Vector3.new(0.95, 0.2, 0.15), n = 14, ns = 6, l0 = 1.4, l1 = -6.5, d0 = 0.18, d1 = 0.07, backT = 0.75, bD0 = 0.16, sub = { dt = Vector3.new(0.8, -0.15, 0.2), db = Vector3.new(0.5, -0.85, 0.15), n = 8, ns = 5, l0 = 2.5, l1 = 1.0, d0 = 0.15, d1 = 0.06 } },
    { label = "Vampire", dt = Vector3.new(0.4, 0.85, 0.35), db = Vector3.new(0.95, 0.15, 0.1), n = 16, ns = 5, l0 = 1.8, l1 = -6.0, d0 = 0.14, d1 = 0.05, backT = 0.65, bD0 = 0.12, sub = { dt = Vector3.new(0.75, -0.25, 0.25), db = Vector3.new(0.35, -0.85, 0.2), n = 10, ns = 4, l0 = 2.8, l1 = 1.1, d0 = 0.12, d1 = 0.04 } },
    { label = "Faerie", dt = Vector3.new(0.35, 0.88, 0.3), db = Vector3.new(0.85, 0.35, 0.25), n = 10, ns = 4, l0 = 1.0, l1 = -4.0, d0 = 0.12, d1 = 0.04, backT = 0.6, bD0 = 0.1, sub = { dt = Vector3.new(0.65, -0.25, 0.3), db = Vector3.new(0.35, -0.75, 0.25), n = 6, ns = 3, l0 = 2.2, l1 = 1.0, d0 = 0.1, d1 = 0.04 } },
    { label = "Butterfly", dt = Vector3.new(0.5, 0.8, 0.3), db = Vector3.new(0.95, 0.1, 0.1), n = 10, ns = 5, l0 = 1.3, l1 = -5.0, d0 = 0.14, d1 = 0.05, backT = 0.55, bD0 = 0.12, sub = { dt = Vector3.new(0.8, -0.2, 0.2), db = Vector3.new(0.3, -0.85, 0.15), n = 6, ns = 4, l0 = 2.5, l1 = 1.0, d0 = 0.12, d1 = 0.04 } },
    { label = "Falcon", dt = Vector3.new(0.25, 0.92, 0.25), db = Vector3.new(0.88, 0.35, 0.18), n = 14, ns = 5, l0 = 1.6, l1 = -5.5, d0 = 0.14, d1 = 0.05, backT = 0.68, bD0 = 0.12, sub = { dt = Vector3.new(0.7, -0.18, 0.25), db = Vector3.new(0.4, -0.82, 0.18), n = 8, ns = 4, l0 = 2.8, l1 = 1.1, d0 = 0.12, d1 = 0.04 } },
    { label = "Dragonel", dt = Vector3.new(0.2, 0.93, 0.2), db = Vector3.new(0.92, 0.25, 0.12), n = 12, ns = 6, l0 = 1.4, l1 = -6.2, d0 = 0.16, d1 = 0.06, backT = 0.72, bD0 = 0.14, sub = { dt = Vector3.new(0.75, -0.2, 0.2), db = Vector3.new(0.45, -0.8, 0.15), n = 6, ns = 4, l0 = 2.5, l1 = 0.9, d0 = 0.14, d1 = 0.05 } },
    { label = "Raven", dt = Vector3.new(0.3, 0.88, 0.3), db = Vector3.new(0.88, 0.32, 0.2), n = 14, ns = 5, l0 = 1.5, l1 = -5.5, d0 = 0.15, d1 = 0.06, backT = 0.62, bD0 = 0.12, sub = { dt = Vector3.new(0.68, -0.22, 0.28), db = Vector3.new(0.38, -0.78, 0.22), n = 8, ns = 4, l0 = 2.7, l1 = 1.0, d0 = 0.13, d1 = 0.05 } },
    { label = "Owl", dt = Vector3.new(0.35, 0.85, 0.35), db = Vector3.new(0.85, 0.35, 0.25), n = 12, ns = 4, l0 = 1.3, l1 = -5.0, d0 = 0.16, d1 = 0.07, backT = 0.58, bD0 = 0.13, sub = { dt = Vector3.new(0.65, -0.25, 0.3), db = Vector3.new(0.35, -0.8, 0.25), n = 8, ns = 4, l0 = 2.5, l1 = 1.0, d0 = 0.14, d1 = 0.06 } },
    { label = "Phoenix", dt = Vector3.new(0.25, 0.92, 0.25), db = Vector3.new(0.9, 0.3, 0.15), n = 14, ns = 6, l0 = 1.7, l1 = -6.5, d0 = 0.15, d1 = 0.05, backT = 0.72, bD0 = 0.12, sub = { dt = Vector3.new(0.72, -0.2, 0.22), db = Vector3.new(0.42, -0.82, 0.18), n = 8, ns = 4, l0 = 3.0, l1 = 1.1, d0 = 0.13, d1 = 0.04 } },
    { label = "Double", dt = Vector3.new(0.3, 0.9, 0.3), db = Vector3.new(0.9, 0.3, 0.2), n = 12, ns = 5, l0 = 1.4, l1 = -5.5, d0 = 0.14, d1 = 0.05, backT = 0.65, bD0 = 0.12, sub = { dt = Vector3.new(0.7, -0.2, 0.3), db = Vector3.new(0.4, -0.8, 0.2), n = 8, ns = 4, l0 = 2.7, l1 = 1.0, d0 = 0.12, d1 = 0.04 } }
}
...
local function GetPlayerRelation(p)
    if not p then return "none" end
    if p == player then return "my" end
...
getgenv().ELITE_HUB_GetPlayerRelation = GetPlayerRelation
...
-- ИГРОКИ tab (players region) — зеркало modules/players.lua
local PlayersTab = getgenv().ELITE_HUB_PlayersTab
